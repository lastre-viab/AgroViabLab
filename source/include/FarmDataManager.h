...
#ifndef FARMDATAMANAGER_H_
#define FARMDATAMANAGER_H_

#include "defs.h"
#include "CycleData.h"
#include "viablab_export.h"

class VIABLAB_LIBRARY_EXPORT FarmDataManager {
public:
	FarmDataManager();
	FarmDataManager( string specFile, string farmFile, string numFile);
